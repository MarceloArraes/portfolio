...
function createControls() {
  ...
  paramsFolder.add(params, "distance", 0, 0.2).onChange(updateUniforms);
  paramsFolder.add(params, "clickRandomizer", 0, 1).onChange(updateUniforms);
  paramsFolder.add(params, "edgeThickness", 0, 0.02).onChange(updateUniforms);
}
